...
#SBATCH --mem=32G
#SBATCH --output=logs/full_order_embeddings_SBERT_3way_hyperbolic_%j.out
#SBATCH --error=logs/full_order_embeddings_SBERT_3way_hyperbolic_%j.err
...
python src/hyperbolic_order_embeddings_asymmetry.py
