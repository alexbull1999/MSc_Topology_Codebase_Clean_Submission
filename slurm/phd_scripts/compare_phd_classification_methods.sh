#!/bin/bash
#SBATCH --job-name=phd_classification_comparison
#SBATCH --partition=gpgpuC
#SBATCH --time=02:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --output=../phd_logs/phd_classification_comparison_%j.out
#SBATCH --error=../phd_logs/phd_classification_comparison_%j.err
...
# Run PHD computation
python phd_method/src_phd/synthetic_vs_multiscale_phd_classification.py
