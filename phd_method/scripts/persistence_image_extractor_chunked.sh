...
#SBATCH --mem=32G
#SBATCH --output=../logs/CHUNKED_MNLI_OWN_MODELS_PERSISTENCE_IMAGE_EXTRACTION_%j.out
#SBATCH --error=../logs/CHUNKED_MNLI_OWN_MODELS_PERSISTENCE_IMAGE_EXTRACTION_%j.err
...
python MSc_Topology_Codebase/phd_method/src_phd/precompute_persistence_images_chunked.py
