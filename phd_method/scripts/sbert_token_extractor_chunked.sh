...
#SBATCH --mem=64G
#SBATCH --output=../logs/Chunked_Token_Extractor_SNLI+MNLI_Train_ALL_SAMPLES_%j.out
#SBATCH --error=../logs/Chunked_Token_Extractor_SNLI+MNLI_Train_ALL_SAMPLES_%j.err
...
python MSc_Topology_Codebase/phd_method/src_phd/sbert_token_extractor_chunked.py
