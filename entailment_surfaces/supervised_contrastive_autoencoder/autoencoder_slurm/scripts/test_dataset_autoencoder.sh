...
#SBATCH --mem=32G
#SBATCH --output=../logs/test_snli_dataset_autoencoder_%j.out
#SBATCH --error=../logs/test_snli_dataset_autoencoder_%j.err
...
python entailment_surfaces/supervised_contrastive_autoencoder/src/snli_test_dataset_classification_global_model.py
