#!/bin/bash
#SBATCH --job-name=enhanced_classification
#SBATCH --partition=gpgpuC
#SBATCH --time=24:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --output=../logs/enhanced_classification_cosine_contrastive_%j.out
#SBATCH --error=../logs/enhanced_classification_cosine_contrastive_%j.err
...
python entailment_surfaces/supervised_contrastive_autoencoder/src/enhanced_classification_evaluator.py
