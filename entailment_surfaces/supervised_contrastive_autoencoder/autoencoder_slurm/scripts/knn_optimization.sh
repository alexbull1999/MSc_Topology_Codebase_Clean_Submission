#!/bin/bash
#SBATCH --job-name=knn_optimization
#SBATCH --partition=gpgpuC
#SBATCH --time=6:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --output=../logs/knn_optimization_vCosineConcat_%j.out
#SBATCH --error=../logs/knn_optimization_vCosineConcat_%j.err
...
python entailment_surfaces/supervised_contrastive_autoencoder/src/knn_optimization.py
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "KNN Optimization successful!"
    echo ""
