#!/bin/bash
#SBATCH --job-name=latent_clustering
...
echo ""
echo "Starting Latent PERSIM clustering..."
echo ""

export PYTHONUNBUFFERED=1

python entailment_surfaces/supervised_contrastive_autoencoder/src/latent_embeddings_clustering_validation_vPersim.py
