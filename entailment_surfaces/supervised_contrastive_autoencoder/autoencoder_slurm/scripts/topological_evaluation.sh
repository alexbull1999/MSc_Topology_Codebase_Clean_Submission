#!/bin/bash
#SBATCH --job-name=topological_evaluation
#SBATCH --partition=gpgpuC
#SBATCH --time=24:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --output=../logs/Topo_Eval_Lattice_%j.out
#SBATCH --error=../logs/Topo_Eval_Lattice_%j.err
...
python entailment_surfaces/supervised_contrastive_autoencoder/src/topological_evaluation.py
