...
#SBATCH --mem=32G
#SBATCH --output=../logs/FIXED3way_marginloss_hyperparam_lattice_oe_%j.out
#SBATCH --error=../logs/FIXED3way_marginloss_hyperparam_lattice_oe_%j.err
...
python entailment_surfaces/order_embeddings_lattice_hyperparam_search_sbert.py 
